...
function Copyrights() {
  return (
    <div className="col-span-full col-start-6 row-start-3 grid grid-cols-subgrid border-r border-main-grey-700 border-opacity-25 pt-4 sm:col-span-3 sm:row-start-1 sm:row-end-3 md:mx-10 md:mt-12 lg:col-span-full lg:row-start-2 lg:border-t xl:mt-24 xl:pt-11">
